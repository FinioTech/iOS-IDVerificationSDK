...
#   spec.name         = "eKYCFramework"
#   spec.version      = "0.0.1"
#   spec.summary      = "A short description of eKYCFramework."
...
#   spec.homepage     = "http://EXAMPLE/eKYCFramework"
...
#   spec.author             = { "Abdul Motalab Rakib" => "rakib@newroztech.com" }
#   # Or just: spec.author    = "Abdul Motalab Rakib"
#   # spec.authors            = { "Abdul Motalab Rakib" => "rakib@newroztech.com" }
#   # spec.social_media_url   = "https://twitter.com/Abdul Motalab Rakib"
...
#   spec.source       = { :git => "http://EXAMPLE/eKYCFramework.git", :tag => "#{spec.version}" }
...
eKYCFramework is quickest, most convenient, and safest way to detecting objects, recognize,crop and validation of NID and user image bia apis for supports in your app .
  ...
  s.source           = { :http => 'https://finiotech-idverificaiton.s3.ap-south-1.amazonaws.com/ios-sdk/eKYCFramework.zip' }
